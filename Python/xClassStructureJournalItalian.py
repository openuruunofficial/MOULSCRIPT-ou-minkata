...
xJournalContents = """<cover src="xClassStructureJournalCover_eng*1#0.hsm"><font size=18 face=Tricia color=982A2A style=b><margin left=62 right=62 top=48><p align=center>Struttura delle Classi
