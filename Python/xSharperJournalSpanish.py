...
xJournalContents = """<cover src="xSharperJournalCover*1#0.hsm"><font size=18 face=Sharper color=982A2A><margin left=62 right=62 top=48>14.11.97 - Parece que han accedido a dejarme tomar el "control" de Teledahn. Oficialmente es hora de iniciar el diario. 
