...
<font size=24>La verità dell'uomo si trova nell'oscurità, al di sotto della superficie. Un po' di luce potrebbe rivelare solo ciò che alcuni vogliono che sia visto.
...
<font size=24>Le leggi adottate dall'orgoglioso sono sia la sua sicurezza che la sua rovina. Tali leggi rendono la disobbedienza una virtù, e l'obbedienza un peccato.
...
<font size=24>Soltanto quando l'uomo si nasconde rivela se stesso. Una debole scintilla può svelare tutto. Guarda nel profondo, pondera e riconosci tutto ciò che è nascosto.
...
<font size=24>Quando si è preso tutto da una persona, l'unica speranza è ciò che l'altro può dare. Attraverso questo dono, entrambi sono redenti.
