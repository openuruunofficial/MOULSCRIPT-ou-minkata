 ...
 *==LICENSE==* """
# xGrsnWallHelpJournalFrench
# change the contents of the variable below to the desired contents of the journal
xJournalContents = """<cover src="xGarrisonWallJournalCover_fre*1#0.hsm"><font size=10 face=courier color=000000><margin left=62 right=62 top=48><p align=center>
...
Trois boutons situés à gauche du panneau permettaient d'accéder rapidement à un nombre prédéfini d'obstacles. Le bouton du bas était pour cinq, celui du milieu pour dix et celui du haut pour quinze. Des lumières pourpres (elles me semblent roses) tout en haut, représentaient le nombre d'obstacles sélectionnés pour l'équipe pourpre et les lumières jaunes indiquaient les obstacles de l'équipe jaune. On pouvait élever ou abaisser les obstacles à l'aide des boutons situés sur le côté droit. Si une équipe souhaitait avoir dix-sept obstacles, il lui fallait appuyer une fois sur le bouton en haut à gauche et deux fois sur le bouton en haut à droite. Ouais, j'ai déjà vu des interfaces plus intuitives.
...
Les deux équipes courent vers le haut, en essayant d'éviter les obstacles qui ont été définis par les ennemis. Ces obstacles ne sont pas visibles mais ils font tomber les joueurs du mur s'ils les touchent. Donc, il faut essayer d'arriver avant l'adversaire et espérer que vous ne serez pas jeté à terre par un obstacle. Si vous tombez par terre, tentez de vous souvenir de l'obstacle pour ne pas tomber deux fois. Et n'oubliez pas ces moments difficiles quand les flammes arrivent jusqu'à vous et que vous transpirez dans votre costume. Allez aussi vite que vous pouvez. Oui, je dirais qu'avec ça ils étaient plutôt bien entraînés.   
